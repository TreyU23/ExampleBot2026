...
public class TunerConstants {
    ...
    private static final Current kSlipCurrent = Amps.of(CurrentLimitConstants.kDriveStatorLimit);
    ...
    private static final TalonFXConfiguration driveInitialConfigs = new TalonFXConfiguration()
            .withCurrentLimits(new CurrentLimitsConfigs().withStatorCurrentLimit(kSlipCurrent)
                    .withStatorCurrentLimitEnable(true).withSupplyCurrentLimit(Amps.of(CurrentLimitConstants.kDriveSupplyLimit))
    ...
    private static final TalonFXConfiguration steerInitialConfigs = new TalonFXConfiguration()
            .withCurrentLimits(
                    new CurrentLimitsConfigs()
                            ...
                            .withStatorCurrentLimit(Amps.of(CurrentLimitConstants.kSteerStatorLimit))
                            .withStatorCurrentLimitEnable(true).withSupplyCurrentLimit(Amps.of(CurrentLimitConstants.kSteerSupplyLimit))
                            .withSupplyCurrentLimitEnable(true));
    ...
    // This needs to be tuned to your individual robot
    public static final LinearVelocity kSpeedAt12Volts = MetersPerSecond.of(4.568571);

    // Every 1 rotation of the azimuth results in kCoupleRatio drive motor turns;
    // This may need to be tuned to your individual robot
    private static final double kCoupleRatio = 36.0/12.0;
    ...
    public static CommandSwerveDrivetrain createDrivetrain() {
        return new CommandSwerveDrivetrain(
                DrivetrainConstants, 250, VecBuilder.fill(0.229, 0.229, 0.229), VecBuilder.fill(10, 10, 10), FrontLeft,
